...
-- Add translations for names days of the week for your language
                 ...
                 ca = { "DIUMENGE", "DILLUNS", "DIMARTS", "DIMECRES",
...
function conky_calendar ()
	local t = { lang          = "ca", -- Language for display Months and Days of week
